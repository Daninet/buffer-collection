...
class BufferCollection {
  ...
  readUIntBE (offset, byteLength, noAssert) {
    if (byteLength === 6)
      return this.readUInt48BE(offset, byteLength);
    if (byteLength === 5)
      return this.readUInt40BE(offset, byteLength);
    if (byteLength === 3)
      return this.readUInt24BE(offset, byteLength);
    if (byteLength === 4)
      return this.readUInt32BE(offset, byteLength);
    if (byteLength === 2)
      return this.readUInt16BE(offset, byteLength);
    if (byteLength === 1)
      return this.readUInt8(offset, byteLength);
  ...
  readUIntLE (offset, byteLength, noAssert) {
    if (byteLength === 6)
      return this.readUInt48LE(offset, byteLength);
    if (byteLength === 5)
      return this.readUInt40LE(offset, byteLength);
    if (byteLength === 3)
      return this.readUInt24LE(offset, byteLength);
    if (byteLength === 4)
      return this.readUInt32LE(offset, byteLength);
    if (byteLength === 2)
      return this.readUInt16LE(offset, byteLength);
    if (byteLength === 1)
      return this.readUInt8(offset, byteLength);
  ...
  readIntBE (offset, byteLength, noAssert) {
    if (byteLength === 6)
      return this.readInt48BE(offset, byteLength);
    if (byteLength === 5)
      return this.readInt40BE(offset, byteLength);
    if (byteLength === 3)
      return this.readInt24BE(offset, byteLength);
    if (byteLength === 4)
      return this.readInt32BE(offset, byteLength);
    if (byteLength === 2)
      return this.readInt16BE(offset, byteLength);
    if (byteLength === 1)
      return this.readInt8(offset, byteLength);
  ...
  readIntLE (offset, byteLength, noAssert) {
    if (byteLength === 6)
      return this.readInt48LE(offset, byteLength);
    if (byteLength === 5)
      return this.readInt40LE(offset, byteLength);
    if (byteLength === 3)
      return this.readInt24LE(offset, byteLength);
    if (byteLength === 4)
      return this.readInt32LE(offset, byteLength);
    if (byteLength === 2)
      return this.readInt16LE(offset, byteLength);
    if (byteLength === 1)
      return this.readInt8(offset, byteLength);
  ...
  writeIntBE (value, offset, byteLength, noAssert) {
    if (byteLength === 6)
      return this._writeBytesBE(value, offset, byteLength, -0x800000000000, 0x7fffffffffff);
    if (byteLength === 5)
      return this._writeBytesBE(value, offset, byteLength, -0x8000000000, 0x7fffffffff);
    if (byteLength === 3)
      return this._writeBytesBE(value, offset, byteLength, -0x800000, 0x7fffff);
    if (byteLength === 4)
      return this._writeBytesBE(value, offset, byteLength, -0x80000000, 0x7fffffff);
    if (byteLength === 2)
      return this._writeBytesBE(value, offset, byteLength, -0x8000, 0x7fff);
    if (byteLength === 1)
      return this._writeBytesBE(value, offset, byteLength, -0x80, 0x7f);
    if (byteLength === 0)
      return offset;
  ...
  writeUIntBE (value, offset, byteLength, noAssert) {
    if (byteLength === 6)
      return this._writeBytesBE(value, offset, byteLength, 0, 0xffffffffffffff);
    if (byteLength === 5)
      return this._writeBytesBE(value, offset, byteLength, 0, 0xffffffffff);
    if (byteLength === 3)
      return this._writeBytesBE(value, offset, byteLength, 0, 0xffffff);
    if (byteLength === 4)
      return this._writeBytesBE(value, offset, byteLength, 0, 0xffffffff);
    if (byteLength === 2)
      return this._writeBytesBE(value, offset, byteLength, 0, 0xffff);
    if (byteLength === 1)
      return this._writeBytesBE(value, offset, byteLength, 0, 0xff);
    if (byteLength === 0)
      return offset;
  ...
  writeIntLE (value, offset, byteLength, noAssert) {
    if (byteLength === 6)
      return this._writeBytesLE(value, offset, byteLength, -0x800000000000, 0x7fffffffffff);
    if (byteLength === 5)
      return this._writeBytesLE(value, offset, byteLength, -0x8000000000, 0x7fffffffff);
    if (byteLength === 3)
      return this._writeBytesLE(value, offset, byteLength, -0x800000, 0x7fffff);
    if (byteLength === 4)
      return this._writeBytesLE(value, offset, byteLength, -0x80000000, 0x7fffffff);
    if (byteLength === 2)
      return this._writeBytesLE(value, offset, byteLength, -0x8000, 0x7fff);
    if (byteLength === 1)
      return this._writeBytesLE(value, offset, byteLength, -0x80, 0x7f);
    if (byteLength === 0)
      return offset;
  ...
  writeUIntLE (value, offset, byteLength, noAssert) {
    if (byteLength === 6)
      return this._writeBytesLE(value, offset, byteLength, 0, 0xffffffffffffff);
    if (byteLength === 5)
      return this._writeBytesLE(value, offset, byteLength, 0, 0xffffffffff);
    if (byteLength === 3)
      return this._writeBytesLE(value, offset, byteLength, 0, 0xffffff);
    if (byteLength === 4)
      return this._writeBytesLE(value, offset, byteLength, 0, 0xffffffff);
    if (byteLength === 2)
      return this._writeBytesLE(value, offset, byteLength, 0, 0xffff);
    if (byteLength === 1)
      return this._writeBytesLE(value, offset, byteLength, 0, 0xff);
    if (byteLength === 0)
      return offset;
